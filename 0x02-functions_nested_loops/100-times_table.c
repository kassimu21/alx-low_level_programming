 ...
 *
 * Description: this function takes a number, perses that number and then prints it to the terminal.
 * It can only parse and print numbers less than or up to three digits in length.
 * Return: Void
 */
